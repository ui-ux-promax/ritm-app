...
const items: BentoItem[] = [
  ...
  },
  {
    ...
    className: 'h-[220px] min-[640px]:col-start-3 min-[640px]:row-start-1 min-[640px]:h-auto',
    x: -22,
    y: -14,
  },
  {
    ...
    className: 'h-[320px] min-[640px]:col-start-4 min-[640px]:row-start-1 min-[640px]:row-span-2 min-[640px]:h-auto',
    x: 14,
    y: -24,
  },
  {
    ...
    className: 'h-[320px] min-[640px]:col-start-1 min-[640px]:row-start-2 min-[640px]:row-span-2 min-[640px]:h-auto',
    x: -16,
    y: 24,
  },
  {
    ...
    className: 'col-span-2 h-[220px] min-[640px]:col-start-2 min-[640px]:row-start-2 min-[640px]:h-auto',
    x: 24,
    y: 14,
  },
  {
    ...
    className: 'col-span-2 h-[220px] min-[640px]:col-start-2 min-[640px]:row-start-3 min-[640px]:h-auto',
    x: -20,
    y: -20,
  },
  {
    ...
    className: 'col-span-2 h-[220px] min-[640px]:col-span-1 min-[640px]:col-start-4 min-[640px]:row-start-3 min-[640px]:h-auto',
    x: 18,
    y: 22,
  },
];
