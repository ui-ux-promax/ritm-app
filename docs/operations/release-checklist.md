...
- [ ] Vercel Production contains demo/sandbox Neon, YooKassa, Upstash, Sentry, Resend, Cloudinary, `DEMO_MODE=true`, and `CRON_SECRET`; no value is copied into this document.
