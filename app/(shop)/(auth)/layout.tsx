      ...
      <aside className="relative hidden lg:flex flex-col justify-between p-10 overflow-hidden bg-footer text-primary-foreground">
        ...
        <div className="relative z-1 max-w-[460px] mb-2">
          ...
          <div className="flex flex-wrap gap-2.5 mt-6">
            <span className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full bg-primary-foreground/10 border border-primary-foreground/16 text-[12.5px] font-semibold text-primary-foreground/92">
